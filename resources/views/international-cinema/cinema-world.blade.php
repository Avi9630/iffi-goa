...
@section('content')
    ...
    <div class="container-fluid page-header bannerBg-worldCinema py-5">
                                ...
                                <div class="card-text d-flex">
                                    <div class="iCinema-content">
                                        ...
                                        <h5>
                                            ...
                                            <span>:</span>
                                            <span>{{ $cinema->directed_by }}</span>
                                        </h5>
                                        <h5>
                                            <span>Country of Origin</span>
                                            <span>:</span>
                                            <span>{{ $cinema->country_of_origin }}</span>
                                        </h5>
                                        <h5>
                                            <span>Language</span>
                                            <span>:</span>
                                            <span>{{ $cinema->language }}</span>
                                        </h5>
                                    </div>
                                </div>
                            </div>
