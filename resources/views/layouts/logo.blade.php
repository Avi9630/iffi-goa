...
<div class="col-lg-12">
    <div class="logo-section " id="menu">
        ...
        <div class="container">
            <div class="top-logo ">
                <a href="{{ route('/') }}">
                    <img class="iffi-logo" src="{{ asset('public/images/logo/IFFI57.png') }}" alt="iffi-logo"
                        loading="lazy">
                </a>
                ...
                <a href="https://www.iffigoa.org">
                    <img src="{{ asset('public/images/header-logo/iffi-logo.png') }}" alt=" Peacock-fill"
                        class="peacock-logo" loading="lazy">
                </a>
                ...
                <a href="https://films.wavesbazaar.com/" target="_blank">
                    <img src="{{ asset('public/images/header-logo/WavesFilmBazaar.png') }}" alt="Film-Bazar"
                        loading="lazy">
                </a>
