            ...
            <div class="row ">
                ...
                <div class="col-md-6 col-sm-6 col-12 mb-4">
                    ...
                    <p class="mb-0">
                        ...
                        brilliant
                        works by first-time filmmakers from India. The new initiative would be an important one to recognize
                        and encourage fresh talent in the Indian film industry, providing an opportunity to gain greater
                        access to the global platform. With the spotlight on the films of debut directors, IFFI 2024 once
                        again confirms its commitment to fostering youth creativity for the Indian Cinema <a
                            class="text-underline" style="font-weight: 600; text-decoration: underline;"
                ...
                <div class="col-md-6 col-sm-6 col-12 mb-4">
                    ...
                    <p class="mb-0">
                        ...
                        <br> <a class="text-underline" style="font-weight: 600; text-decoration: underline;"
                            href="https://iffigoa.org/festival/creative-mind-tomorrow">View your entry.</a>
                    </p>
                </div>
