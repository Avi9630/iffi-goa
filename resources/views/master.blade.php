        ...
        const modalData = {
            ...
            nov21: [{
                ...
                },
                {
                    ...
                    panel: "Panel Discussion",
                    date: "Nov 21st, 2024, 02.30 PM TO 04.00 PM",
                ...
                },
                {
                    ...
                    speakers: [{
                            name: "Rana Daggubati",
                            description: "Rana Daggubati is an Indian actor, film producer and a television personality who primarily works in Telugu cinema, in addition to Tamil and Hindi films. He is a recipient of several accolades including a National Film Award. He marked his acting debut with Leader (2010), which established him as a bankable actor in the Telugu film industry. He then went on to foray into Hindi cinema, or the popular Bollywood, with Dum Maaro Dum (2011). He subsequently acted in several Telugu and Hindi films, before his role as the lead antagonist in the film, Baahubali: The Beginning (2015), catapulting him to new heights of stardom.",
                            image: "{{ asset('public/images/master-class/Kushboo Sundar.jpg') }}"
                        },
                        {
            ...
            //     },
            //     // {
            //     //     title: '<b style="color: red">Yet To Fix</b>',
            //     //     moderator: "",
            //     //     panel: "Masterclass",
            //     //     date: "Nov-26th, 2024, 12.30 PM TO 01.30 PM",
            //     //     // description: "In this session, the acclaimed filmmaker Vidhu Vinod Chopra takes us on a journey through the creative process, sharing his experiences, challenges, and the philosophy behind living through cinema.With decades of storytelling mastery,Mr. Chopra will bring us the insights into how films not only reflect life but become a living entity of their own, inspiring generations ",
        ...
        document.querySelectorAll('.title-tab').forEach(tab => {
            tab.addEventListener('click', function() {
                ...
                if (data) {
                    ...
                    <span>
                        <img src="${speaker.image}" class="img-circle" style="cursor: pointer;" 
                             onclick="showSpeakerDetails('${speaker.name}', '${speaker.description}', '${speaker.image}')">
                    </span>
                `;
