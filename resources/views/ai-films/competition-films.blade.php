...
@section('content')
    ...
    <div class="container-fluid page-header bannerBg-non-feature py-5">
        <div class="container text-center ">
            <h1 class="page-title-header">AI Competition Films {{ $year }}</h1>
        </div>
    </div>

    @php
        $subCategory = [
            1 => 'Individual filmmakers (INDIA)',
            2 => 'Individual Filmmakers (International)',
            3 => 'Burano AIFF',
            4 => 'OMNI FILM FESTIVAL',
            5 => 'AI Film & Art Festival(ARIZONA)',
            6 => 'ADOBE',
            7 => 'Meta Morph',
        ];
        $displayOrder = [1, 2, 3, 4, 5, 6, 7];
    @endphp
        ...
        <div class="container">
            <div class="row">
                @foreach ($displayOrder as $subCatId)
                    @if (isset($competitions[$subCatId]))
