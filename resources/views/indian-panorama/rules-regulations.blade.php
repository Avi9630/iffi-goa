...
@section('site_description', 'Find key rules and regulations for participating in the Indian Panorama section at IFFI
...
@section('content')
    ...
    <div class="container-fluid page-header bannerBg-festival-venue py-5">
        <div class="container text-center ">
            <h1 class="page-title-header">INDIAN PANORAMA, 2024 REGULATIONS</h1>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="rules-text">
                        <h5>1. Short Title</h5>
                        <p></p>
                        <p>These regulations shall be called Indian Panorama 2024 Regulations for the 55th edition of
                        ...
                        <ul class="ps-0">
                            ...
                            <li class="liststyleNone">(b) “Corporation” means National Film Development Corporation,
                                ...
                                and Broadcasting.
                                and Broadcasting.</li>
                            <li class="liststyleNone">(c) “Indian Panorama” is a Section of the International Film Festival
                                of India. “Indian
                            ...
                            <li class="liststyleNone">(d)“Producer” is one who produces a film and also has the copy right
                                of the film and can
                                ...
                                a
                                company or an Institute or any other such entity and shall include a co- producer also.</li>
                        </ul>
                        <p></p>
                        <hr>
                        ...
                        <ul class="ps-0">
                            <li class="liststyleNone">(1) International Film Festivals in India and abroad.</li>
                            <li class="liststyleNone">(2) Indian Film Weeks held under Bilateral Cultural Exchange
                            ...
                            <li class="liststyleNone">(3) Special Indian Panorama Festivals in India.</li>
                        </ul>
                        <p></p>
                        <hr>
                        <h5>4. SECTIONS</h5>
                        <p></p>
                        <p>The Indian Panorama will have the following sections:-</p>
                        <ul class="ps-0">
                            <li class="liststyleNone">a) Feature films, and</li>
                            <li class="liststyleNone">b) Non-feature films.</li>
                        </ul>
                        <p></p>
                        <hr>
                        ...
                        <p></p>
                        <hr>
                        <h5>6. ELIGIBILITY CONDITIONS</h5>
                        <p></p>
                        <p>The following conditions must be fulfilled by all entries:
                        </p>
                        <ul class="ps-0">
                            <li class="liststyleNone">6.1 The film should be in any Indian language. The Phrase “any Indian
                                language” would
                                ...
                                <ul class="ps-0">
                                    <li class="liststyleNone">6.1.1 Silent Films will also be eligible.</li>
                                    <li class="liststyleNone">6.1.2 The Director should be an Indian national.</li>
                                    <li class="liststyleNone">6.1.3 The Producer of the film should be an Indian national
                                        and the film should have been
                                        produced in India. However, co-productions with the foreign entity are also
                                        acceptable.</li>
                                </ul>
                            </li>
                            <li class="liststyleNone">6.2 In the case of co-productions involving a foreign entity, the
                                following conditions should
                                be fulfilled :
                                <ul class="ps-0">
                                    <li class="liststyleNone">6.2.1 At least one of the co-producers must be an Indian
                                        entity.</li>
                                    <li class="liststyleNone">6.2.2 The Indian entity should be registered in India or a
                                        citizen of India.
                                    </li>
                                    <li class="liststyleNone">6.2.3 The title of the film should be registered as an Indian
                                        film title.
                                    </li>
                                    <li class="liststyleNone">6.2.4 The Director should be an Indian national. The cast and
                                        technicians should
                                    ...
                                    <li class="liststyleNone">6.2.5 The applicant i.e. Producer/right holder(s) should have
                                        the right for
                        ...
                        <ul class="ps-0">
                            <li class="liststyleNone">(1) If the film (Feature or Non-Feature) has been selected/screened in
                                any
                            ...
                            <li class="liststyleNone">(2) If a film selected for Indian Panorama is not certified by CBFC,
                                NFDC would take
                            ...
                            <li class="liststyleNone">(3) If a film (Censored or Un-censored) entered last year Indian
                                Panorama will not be
                                eligible for Indian Panorama 2024.</li>
                        </ul>
                        <ul class="ps-0">
                            <li class="liststyleNone">6.4 Films made in any Indian language shot in digital/video format and
                                as a feature film
                                or fiction above 72 min duration, are eligible for the Feature Film Section.</li>
                            <li class="liststyleNone">6.5 Films made in any Indian language shot on digital/video format and
                                as a
                                Documentary/News reel/non-fiction/short fiction are eligible for the Non- Feature Film
                                Section.</li>
                            <li class="liststyleNone">6.6 The question of whether a film is a feature film or a non-feature
                                film will be
                                decided based on such categorization mentioned in the entry form and declaration
                                submitted by the applicant.</li>
                            <li class="liststyleNone"><strong>6.7 ALL FILMS MUST CARRY ENGLISH SUBTITLES.</strong></li>
                            <li class="liststyleNone">6.8 For Mainstream Cinema Selection, Film Federation of India, Film
                            ...
                            <li class="liststyleNone">6.9 a) A maximum of five (5) entries would be allowed from
                                ...
                                independent work of the student.</li>
                            <li class="liststyleNone"><strong>6.10 Disqualification:</strong>
                                <br>
                        ...
                        <p></p>
                        <ul class="ps-0">
                            <li class="liststyleNone">7.1 The Producer(s) may apply on the prescribed entry Form IP-I along
                                with Form IP-II.
                                The online entry form and regulations of Indian Panorama 2024 are available on the following
                                websites: www.nfdcindia.com and www.iffigoa.org. </li>
                            <li class="liststyleNone">7.2 Each entry form shall be accompanied by the material detailed
                                below (a soft copy of
                                the same to be sent to&nbsp;<a
                                    href="mailto:indianpanorama@nfdcindia.com">indianpanorama@nfdcindia.com)</a>.<br>
                                (a) Acceptable formats for feature films are DCP - Unencrypted, DCI Compliant – J2K,
                                Interop or SMPTE DCP-Note: J2K, Interop DCP to be only in 24 fps)/ Bluray(region free
                                PAL) along with two DVD copies. Acceptable formats for non-feature films are DCP
                                (Unencrypted, DCI Compliant – J2K, Interop or SMPTE DCP- Note: J2K, Interop DCP to be
                                only in 24 fps Bluray (region free PAL) or Pen drive (containing MP4/MOV/H264,
                                Resolution 1920 x 1080 file).<br>
                                ...
                                4. Posters</li>
                            <li class="liststyleNone">(c)(i) A declaration shall be furnished by the applicant, declaring
                                ...
                                being submitted as required under clause 7.2 (a).</li>
                            <li class="liststyleNone">(ii) It is also certified that the film is not a
                                dubbed/revised/remake/ re-edited
                                version of any film and has not been submitted earlier.</li>
                            <li class="liststyleNone">(iii) The completion year of production of the film is during the 12
                                months preceding
                            ...
                            <li class="liststyleNone">(iv) The film is a Feature or Non- Feature Film (as per clauses 6.4,
                                6.5 &amp; 6.6 of
                                Indian Panorama).</li>
                            <li class="liststyleNone">(d) In case the film is finally selected by the Jury, the following
                                should be submitted
                                immediately.</li>
                            <li class="liststyleNone">1. One DCP (Unencrypted, DCI Compliant-J2K)/Bluray (region-free PAL)
                                copy and Two DVD
                            ...
                            <li class="liststyleNone">2. Three ‘3x2’ posters of the film.</li>
                            <li class="liststyleNone">3. A 30 second-60 seconds promo/trailer by email.</li>
                            <li class="liststyleNone">4. Dialogue Sheets/sub-titles file with time code</li>
                            <li class="liststyleNone">7.3 A non-refundable entry fee of (Rs. 11,800/- including 18% GST) for
                                Feature films and
                                (Rs. 3,540/- including 18% GST) for Non-Feature films must be remitted online at the
                                time of online entry form submission.</li>
                            <li class="liststyleNone">7.4
                                The last date for submission of On- Line applications is 12th August, 2024 till 6.00 P.M.
                                and
                                the last date for receipt of the stamped and signed hard copy of the submitted online
                                application
                                form along with the requisite material is 22nd August, 2024, in case 22nd August, 2024 is
                                declared a
                                ...
                                be
                                same). </li>
                            <li class="liststyleNone">7.5 All entries must be sent to the following address:</li>
                            <li class="liststyleNone">
                            ...
                            <li class="liststyleNone">7.6 Film can be submitted in any of the two formats i.e. DCP
                                (Unencrypted, DCI Compliant
                                – J2K, Interop or SMPTE DCP-Note: J2K, Interop DCP to be only in 24 fps)/ Bluray (region
                                free PAL) for Feature Film and any of the Three formats i.e. DCP (Unencrypted, DCI
                                Compliant – J2K, Interop or SMPTE DCP-Note: J2K, Interop DCP to be only in 24 fps)/
                                Bluray (region free PAL) or Pen drive (containing MP4/MOV/H.264, Resolution 1920x1080
                                file ) for Non-Feature Film..&nbsp;<strong>ENTRIES OF FILMS MUST CARRY ENGLISH
                                    SUBTITLES.</strong>&nbsp;Please label the cover of the DCP/Bluray or Pen Drive with
                                the following details:</li>
                            <li class="liststyleNone">● Title of the film</li>
                            <li class="liststyleNone">● The full name of the Director</li>
                            <li class="liststyleNone">● The full name of the Producer</li>
                            <li class="liststyleNone">● Duration of the film</li>
                            <li class="liststyleNone">● Aspect Ratio of the film</li>
                            <li class="liststyleNone">● Original language of the film</li>
                            <li class="liststyleNone">7.7 All costs for sending the DCP (Unencrypted, DCI Compliant – J2K,
                                Interop or SMPTE
                                ...
                                (s).</li>
                            <li class="liststyleNone">7.8 In case any of the requirements mentioned in this part of the
                                Regulations are not
                        ...
                        <p></p>
                        <ul class="ps-0">
                            <li class="liststyleNone">8.1 The Indian Panorama will be selected by two duly constituted
                            ...
                            <li class="liststyleNone">8.2 The Chairperson of the Feature Film Jury may constitute a maximum
                                of four panels from
                            ...
                            <li class="liststyleNone">8.3 A person will be ineligible to serve on a Jury ONLY if his/her
                                film is an entry. In
                                ...
                                <ul class="ps-0">
                                    <li class="liststyleNone">8.3.1 A person appointed as Chairperson or member of the jury
                                        shall make the
                                        declaration in writing in the form given in Form IP-III annexed to these
                                        Regulations.</li>
                                    <li class="liststyleNone">8.3.2 The Jury Members shall maintain strict confidentiality
                                        regarding the
                            ...
                            <li class="liststyleNone">8.4 The Festival Director, IFFI and/or his/her nominee may attend the
                                deliberations of
                            ...
                            <li class="liststyleNone">8.5 The decision of the juries shall be final and binding and no
                                appeal or
                                correspondence regarding their decision shall be entertained.</li>
                            <li class="liststyleNone">8.6 The films selected for the 71st National Film Awards 2023 for the
                        ...
                        <p></p>
                        <ul class="ps-0">
                            <li class="liststyleNone">9.1 In case a film is selected for the Indian Panorama, the NFDC will
                                have the right to
                            ...
                            <li class="liststyleNone">9.2 NFDC shall have the right to get the DCP-Unencrypted subtitled in
                                English or/and in
                                other languages.</li>
                            <li class="liststyleNone">9.3 NFDC shall have the right to strike foreign language subtitled
                                ...
                                clause 11.2 of the Regulations for Indian Panorama, 2024. </li>
                            <li class="liststyleNone">9.4 NFDC shall have the right to replace the existing prints /DCP-
                                Unencrypted,
                                subtitled or otherwise, once it is certified as damaged.</li>
                            <li class="liststyleNone">9.5 In the case of a film selected for the Indian Panorama, all the
                                ...
                                Regulation.</li>
                            <li class="liststyleNone">9.6 The authorization in forms IP-II shall be made use of by NFDC for
                                the purposes and
                                manner mentioned in Regulation Clause 11, only in case a film is selected for the Indian
                                Panorama.</li>
                            <li class="liststyleNone">9.7 It will be the duty of the concerned Producer/right holders to
                                ensure the
                                ...
                                Panorama.</li>
                            <li class="liststyleNone">9.8 Selected films (feature and non-feature) will be given a
                        ...
                        <p></p>
                        <ul class="ps-0">
                            <li class="liststyleNone">11.1 The Indian Panorama films will initially be screened at the
                                ...
                                reasons.</li>
                            <li class="liststyleNone">11.2 Out of the feature films selected for Indian Panorama, up to
                                ...
                                payment.
                                He/ She will however, be kept informed of such screenings. </li>
                            <li class="liststyleNone">11.3 Debut film(s) of a Director selected for Indian Panorama 2024
                                ...
                                silver
                                peacock.</li>
                            <li class="liststyleNone">11.4 The prints purchased by the National Film Development
                                ...
                                India.</li>
                            <li class="liststyleNone">11.5 Exemption from CBFC certification for the selected films in
                                Indian Panorama
