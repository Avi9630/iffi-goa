...
@section('content')
    ...
    <div class="container-fluid page-header  py-5">
        <div class="container text-center ">
            <h1 class="page-title-header">ABOUT CMOT</h1>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <div class="rules-text">
                        ...
                        <p>3. To encourage and nurture forward-thinking narratives that celebrate Azadi ka Amrit
                            Mahotsab
                            and reflect the aspirations of India in Amrit Kaal.
                        </p>
                        <p><b>Film Crafts</b></p>
                        <p>1. Direction</p>
                        <p>2. Acting</p>
                        <p>3. Cinematography</p>
                        <p>4. Editing and Subtitling</p>
                        <p>5. Scriptwriting</p>
                        <p>6. Playback Singing</p>
                        <p>7. Music Composition</p>
                        <p>8. Sound Recording</p>
                        <p>9. Costume Design</p>
                        <p>10. Hair & Makeup</p>
                        <p>11. Art Direction</p>
                        <p>12. Animation, Visual Effects (VFX), Augmented Reality (AR) and Virtual reality (VR)</p>
