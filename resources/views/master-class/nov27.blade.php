    ...
    <div class="row">
        ...
        <div class="col-md-7 col-12">
            <div class="callout">
                ...
                <p>
                    This session commemorates the centenary of renowned filmmaker
                    Tapan Sinha. It will explore his diverse filmography, his unique approach to storytelling,
                    and his significant contributions to Indian cinema.
                </p>
            </div>
        </div>
        <div class="col-md-3 col-12">
            <div class="user-profile-icon">
                <ul>
                    <li>
                        <img src="{{ asset('public/images/master-class/Arjun Chakrabarty.jpg') }}" alt="image"
                            class="img-fluid">
                    </li>
                    <li>
                        <img src="{{ asset('public/images/master-class/Manu Chakravarthy.jpg') }}" alt="image"
                            class="img-fluid">
                    </li>
                    <li>
                        <img src="{{ asset('public/images/master-class/Sharmila Tagore.jpg') }}" alt="image"
                            class="img-fluid">
                    </li>
                </ul>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-7 col-12">
            <div class="callout">
                ...
                <p>
                    In today's digital age, the lines between truth and perception are often blurred, especially when it
    ...
    <div class="row">
        ...
        <div class="col-md-7 col-12">
            <div class="callout">
                ...
                <p>
                    As a special tribute to the legendary singer Latha Mangeshkar, the
                    International Film Festival of India (IFFI), 2023 featured a commemorative section.In
                    this memorial talk, Oscar-winning composer A R Rahman will prospect through the
                    evolving landscape of musical theatre in India, paying homage to the iconic singer
                    whose voice has been an integral part of Indian musical history. This discussion will
                    take us into how musical theatre in India is growing as a vibrant form of artistic
                    expression influenced by both traditional and contemporary musical elements.
                </p>
            </div>
        </div>
        <div class="col-md-3 col-12">
            <div class="user-profile-icon">
                <ul>
                    <li>
                        <img src="{{ asset('public/images/master-class/A R Rahman.jpg') }}" alt="image"
                            class="img-fluid">
                    </li>
                </ul>
            </div>
