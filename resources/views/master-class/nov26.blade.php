    ...
    <div class="row">
        ...
        <div class="col-md-7 col-9">
            <div class="callout">
                ...
                <p>
                    Animation Director, Chris Kirshbaum, from DNEG Animation as he delves into the often overlooked
                    world of sports as a rich reference for understanding human emotion and behaviour in animation.
                    While animators typically draw inspiration from movies, TV, and real life, sports offer a unique
        ...
        <div class="col-md-3 col-12">
            <div class="user-profile-icon">
                <ul>
                    <li>
                        <img src="{{ asset('public/images/master-class/Chris Kirschbaum.jpg') }}" alt="image"
                            class="img-fluid">
                    </li>
                </ul>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-7 col-9">
            <div class="callout">
                ...
                <p>
                    Stephen Woolley will delve into the intricate process of filmmaking, breaking it down into five
                    essential stages: development, pre-production (including packaging, financing, and casting),
                    production (prep and shooting), post-production, and release and marketing.
                </p>
            </div>
        </div>
        <div class="col-md-3 col-12">
            <div class="user-profile-icon">
                <ul>
                    <li>
                        <img src="{{ asset('public/images/master-class/Stephen Woolley.jpg') }}" alt="image"
                            class="img-fluid">
                    </li>
                </ul>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-7 col-9">
            <div class="callout">
                ...
                <p>
                    The accessibility of feature films in cinema theatres remains a
                    critical issue in the evolving landscape of the different modes of cinema viewing. In this
                    session, the speaker will address the challenges and solutions surrounding the
                    exhibition of films in theaters, particularly in making them accessible to wider and more
                    diverse audiences. From technological advancements to the infrastructure needed for
                    inclusive viewing, Mr. Senthil Kumar will get into the possibilities of how the industry can
                    bridge gaps and ensure that the magic of cinema is available to all in cinema hall.
                </p>
            </div>
        </div>
